...
router.post('/admin/create/blog',authorizedAdmin,
    uploadFile('./uploads/blogImages/').fields([{ name: 'image', maxCount: 1 },{name:'doc',maxCount:1}]),
    createBlog)
...
router.post('/admin/blog/edit',authorizedAdmin, uploadFile('./uploads/blogImages/').fields([{ name: 'image', maxCount: 1 },{name:'doc',maxCount:1}]),editBlog)
