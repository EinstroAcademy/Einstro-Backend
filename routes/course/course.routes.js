...
router.post("/admin/create/university",authorizedAdmin,uploadFile('./uploads/universityImages/').fields([{ name: 'images', maxCount: 10 }]), createUniversity);
router.post("/admin/update/university",authorizedAdmin,uploadFile('./uploads/universityImages/').fields([{ name: 'newImages', maxCount: 10 }]),updateUniversity);
